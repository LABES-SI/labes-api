...
`FakeConectividadeRepository` substitui o repositório real (warehouse) por um
duble assíncrono com dados em memória, para que os testes do
`ConectividadeService` exercitem TODOS os gráficos sem tocar o banco. Cada
