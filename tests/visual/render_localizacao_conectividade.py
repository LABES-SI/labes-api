"""Renderiza o grafico_tp_localizacao_conectividade indo até o banco.
...
Uso:
    uv run python -m tests.visual.render_localizacao_conectividade
    # Ou para testar filtros específicos
    # uv run python -m tests.visual.render_localizacao_conectividade --ano 2024 --variavel in_internet
"""
...
async def _run(
    ...
    # O alvo aqui é o gráfico de Localização
    grafico = painel["data"]["graficos"]["grafico_tp_localizacao_conectividade"]
    ...
    out_file = out_dir / "localizacao_conectividade.html"
