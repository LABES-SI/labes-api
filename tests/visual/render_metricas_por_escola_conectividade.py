"""Renderiza o gráfico "Métricas de conectividade por escola" indo até o banco.

Percorre o mesmo caminho usado pela rota `/conectividade/painel/escolas`: abre
...
Uso:
    uv run python -m tests.visual.render_metricas_por_escola_conectividade --ano 2023 --municipio Abaetetuba
    uv run python -m tests.visual.render_metricas_por_escola_conectividade --ano 2023 --municipio Abaetetuba --page 1 --page_size 5
    # abre tests/visual/out/metricas_por_escola_conectividade.html
"""
...
async def _run(
    ...
    out_file = out_dir / "metricas_por_escola_conectividade.html"
