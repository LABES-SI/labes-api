"""Renderiza o tab_percent de conectividade indo até o banco.
...
Uso:
    uv run python -m tests.visual.render_tab_percent_conectividade
    # abre tests/visual/out/tab_percent_conectividade.html
"""
...
async def _run(
    ...
    grafico = painel["data"]["graficos"]["tab_percent_conectividade"]
    ...
    out_file = out_dir / "tab_percent_conectividade.html"
