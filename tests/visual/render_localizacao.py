"""Renderiza o grafico_dependencia_acessibilidade indo até o banco.
...
Uso:
    uv run python -m tests.visual.render_dependencia
    # Ou para testar filtros específicos
    # uv run python -m tests.visual.render_localizacao --ano 2024 --variavel in_acessibilidade_rampas
"""
...
async def _run(
    ...
    grafico = painel["data"]["graficos"]["grafico_tp_localizacao_acessibilidade"]
    ...
    out_file = out_dir / "localizacao.html"
