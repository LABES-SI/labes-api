...
Uso:
    ...
    # uv run python -m tests.visual.render_dependencia --ano 2024 --variavel in_acessibilidade_rampas
"""
...
async def _run(
    ...
    grafico = painel["data"]["graficos"]["grafico_dependencia_acessibilidade"]
    ...
    out_file = out_dir / "dependencia.html"
